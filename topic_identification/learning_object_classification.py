...
from services.s3_driver import download_models

nltk.download('stopwords')

# Download Topic Classifiers
download_models()
...
bidirectional_rnn_classification_model_path = 'bidirectional_rnn_classifier.sav'
cnn_classification_model_path               = 'cnn_classifier.sav'
rnn_classification_model_path               = 'rnn_classifier.sav'
...
def determine_learning_object_placements(learning_objects):
    ...
    for learning_object in learning_objects:
        ...
        output[learning_object.get('cuid')] = { 'topic_id': most_fequent_index, 'learning_object': learning_object }
